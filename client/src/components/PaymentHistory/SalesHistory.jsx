...
export default function SalesHistory() {
    ...
    useEffect(() => {
        document.title = 'Administrar cuenta - Historial de ventas'
        getUserInfo();
    }, []);
    ...
    return (
        ...
        <div className="flex justify-center items-center h-full">
            <div className="bg-white p-6 rounded-lg shadow-lg">
                <h2 className="text-2xl font-bold mb-4 text-center">Historial de Ventas</h2>
                <p className="text-center">Lo siento, Aún no realizaste ninguna Venta!</p>
            </div>
        </div>
        :
        <div className="flex justify-center items-center h-full">
            ...
            {selectedPayment && (
                <Modal show={openModal} onClose={handleCloseModal}>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-lg">
                        ...
                        <p className="my-4">
                            <span className="font-semibold">Comprada por:</span> {selectedPayment.user}
                        </p>
                    </div>
                    </Modal.Body>
                    <Modal.Footer>
