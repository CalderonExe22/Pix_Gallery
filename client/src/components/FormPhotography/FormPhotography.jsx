...
export default function FormPhotography({image}) {
    ...
    return (
        <form className="flex flex-col gap-5 w-2/3 ms-20 me-20 text-lg" onSubmit={handleSubmit(onSubmit)}>
            <h1 className="text-4xl mb-5">Subir fotografia</h1>
            ...
            <div className="flex flex-col gap-3">
                ...
                <input className={style.inputs} id="tags" type="text" name='tags' placeholder="Ingrese tags adicionales"
                    onKeyDown={(e) => {
                        if(e.key === 'Enter'){
                            e.preventDefault()
            ...
            <div className="grid grid-cols-2 w-full h-auto gap-4">
                ...
                <div className="w-full col-span-2">
                    <Input type="text" name='camera' placeholder="Camara" register={register} errors={errors} classNameStyle={style.inputs}/>
                </div>
                <div className="w-full col-span-2">
                    <Input type="text" name='lens' placeholder="lente" register={register} errors={errors} classNameStyle={style.inputs}/>
                </div>
                <div className="w-full">
                    <Input type="number" name='focal_length' placeholder="Distancia focal" register={register} errors={errors} classNameStyle={style.inputs}/>
                </div>
                <div className="w-full">
                    <Input type="number" name='shutter_speed' placeholder="velocidad de abturacion" register={register} errors={errors} classNameStyle={style.inputs} />
                </div>
                <div className="w-full">
                    <Input type="number" name='aperture' placeholder="Apertura" register={register} errors={errors} classNameStyle={style.inputs} />
                </div>
                <div className="w-full ">
                    <Input type="number" name='iso' placeholder="ISO" register={register} errors={errors} classNameStyle={style.inputs} />
                </div>
            </div>      
